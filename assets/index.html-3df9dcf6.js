import{_ as r,r as t,o as c,c as u,b as n,d as i,w as a,e,f as d}from"./app-bbc30330.js";const v={},o={class:"table-of-contents"},m=d('<h1 id="指南" tabindex="-1"><a class="header-anchor" href="#指南" aria-hidden="true">#</a> 指南</h1><h2 id="deploy" tabindex="-1"><a class="header-anchor" href="#deploy" aria-hidden="true">#</a> Deploy</h2><h3 id="npx-vuepress-build-clean-temp" tabindex="-1"><a class="header-anchor" href="#npx-vuepress-build-clean-temp" aria-hidden="true">#</a> npx vuepress build --clean-temp</h3><blockquote><p>npx vuepress build --clean-temp</p></blockquote>',4),b={id:"github-pages-with-github-actions-to-auto-deploy",tabindex:"-1"},p=n("a",{class:"header-anchor",href:"#github-pages-with-github-actions-to-auto-deploy","aria-hidden":"true"},"#",-1),h={href:"https://v2.vuepress.vuejs.org/zh/guide/deployment.html#github-pages",target:"_blank",rel:"noopener noreferrer"},g=d(`<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>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
